    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresas', models.ManyToManyField(blank=True, related_name='usuarios', to='ticketApp.empresas')),
                ('grupos', models.ManyToManyField(blank=True, related_name='usuarios', to='ticketApp.grupos')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='tickets',
            name='usuario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='ticketApp.usuarios'),
        ),
    ]
